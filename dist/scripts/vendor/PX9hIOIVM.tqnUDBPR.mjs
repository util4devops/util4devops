...
import { S as m, a as h, r as te, t as ne } from "./motion.CzGBN5me.mjs";
import {
  N as g,
  Q as re,
  S as _,
...
function le() {
  ...
  let t = null,
    n = !1;
  if (r.location.ancestorOrigins && r.location.ancestorOrigins.length > 0) {
    let e = r.location.ancestorOrigins[0];
    try {
      t = new URL(e).host;
    } catch {}
  ...
  return (t && (n = t === T || t.endsWith(`.${T}`)), n);
}
function ue(e) {
  return p((t, n) => {
    let i = s(E, D, O),
      a = ae.current() === ae.canvas;
    return i && !a
      ? null
      : u(e, {
          ...t,
          ...
          onClick: (e) => {
            (e.preventDefault(),
              r.open(
                `https://www.framer.com/r/badge/?utm_campaign=freeplanbadge&utm_source=${encodeURIComponent(r?.location?.origin)}`
              ));
          },
  ...
  pe = e(() => {
    (d(),
      ...
      (I = b(
        ...
        [
          `.framer-g7oZR { -webkit-mask-image: ${k}; -webkit-mask-position: ${M}; -webkit-mask-repeat: ${j}; -webkit-mask-size: ${N}; aspect-ratio: 9.7; background-color: var(--1bd4d3i); mask-image: ${k}; mask-mode: ${A}; mask-position: ${M}; mask-repeat: ${j}; mask-size: ${N}; width: 97px; }`,
        ],
        `framer-g7oZR`
      )),
      (I.displayName = `Text`),
...
e(() => {
  (d(),
    ...
    (G = g(W)),
    (K = g(I)),
    (q = x(I, { nodeId: `pBR1Ew0r8`, override: de, scopeId: `PX9hIOIVM` })),
    (J = oe(S(x(m.a, { nodeId: `HK2sXlagE`, override: ue, scopeId: `PX9hIOIVM` })))),
    (Y = `framer-6jWyo`),
    ...
    (ye = ({ value: e, children: t }) => {
      ...
      return u(h.Provider, { value: i, children: t });
    }),
    (be = m.create(i)),
    ...
    (Q = b(
      p(function (e, t) {
        let n = ee(null),
          r = t ?? n,
          i = c(),
          { activeLocale: a, setLocale: o } = se();
        re();
        let { style: s, className: l, layoutId: d, variant: p, ...h } = xe(e),
          {
            baseVariant: ne,
            classNames: g,
            ...
            setVariant: oe,
            variants: S,
          } = ce({ defaultVariant: `HK2sXlagE`, ref: r, variant: p, variantClassNames: X }),
          C = Se(e, S),
          w = v(Y);
        return u(te, {
          id: d ?? i,
            ...
            children: u(ye, {
              ...
              children: u(ie, {
                ...
                children: f(J, {
                  ...
                  __targetOpacity: 1,
                  className: `${v(w, `framer-n0ccwk`, l, g)} framer-bmpgw8`,
    ...
    w(Q, [{ explicitInter: !0, fonts: [] }, ...G, ...K], { supportsExplicitInterCodegen: !0 }),
    ($ = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.tqnUDBPR.mjs.map
