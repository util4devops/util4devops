...
import { S as p, a as m, r as ne, t as re } from "./motion.CYX_XZth.mjs";
import {
  B as h,
  M as g,
  Z as ie,
  ...
  me = e(() => {
    (u(),
      ...
      (N = s((e, t) => {
        ...
        return n ? c(p.div, { ...a, layoutId: r, ref: t }) : c(`div`, { ...a, ref: t });
      })),
...
e(() => {
  (u(),
    ...
    (q = se(oe(x(p.a, { nodeId: `HK2sXlagE`, override: de, scopeId: `PX9hIOIVM` })))),
    (J = `framer-6jWyo`),
    ...
    (ye = ({ value: e, children: t }) => {
      ...
      return c(m.Provider, { value: o, children: t });
    }),
    (be = p.create(n)),
    ...
    (Q = y(
      s(function (e, n) {
        let r = t(null),
          i = n ?? r,
          a = te(),
          { activeLocale: o, setLocale: s } = ce();
        ie();
        let { style: u, className: d, layoutId: ee, variant: f, ...m } = xe(e),
          {
            baseVariant: re,
            classNames: h,
            ...
            setVariant: y,
            variants: b,
          } = ae({ defaultVariant: `HK2sXlagE`, ref: i, variant: f, variantClassNames: Y }),
          x = Se(e, b),
          C = S(J);
        return c(ne, {
          id: ee ?? a,
            ...
            children: c(ye, {
              ...
              children: c(le, {
                ...
                children: l(q, {
                  ...
                  __targetOpacity: 1,
                  className: `${S(C, `framer-n0ccwk`, d, h)} framer-bmpgw8`,
    ...
    _(Q, [{ explicitInter: !0, fonts: [] }, ...W, ...G], { supportsExplicitInterCodegen: !0 }),
    ($ = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.z6vKQoWc.mjs.map
