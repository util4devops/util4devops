...
var Bn,
  ...
  Qn = e(() => {
    (x(),
      ...
      (Q = B(
                      ...
                      _(U, {
                        children: _(z, {
                          ...
                          children: _(Ge, {
                            ...
                            topLeftRadius: 12,
                            topRightRadius: 12,
                            url: `https://www.youtube.com/watch?v=z-m5TXg2kbM&feature=youtu.be`,
                            width: `100%`,
                          }),
                        }),
                      }),
        ...
        [
          `@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }`,
          `.framer-onnic.framer-1oef5im, .framer-onnic .framer-1oef5im { display: block; }`,
          `.framer-onnic.framer-16wermw { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: visible; padding: 5px; position: relative; width: min-content; }`,
          `.framer-onnic .framer-1gyno9q { align-content: center; align-items: center; cursor: pointer; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 21px; justify-content: center; overflow: var(--overflow-clip-fallback, clip); padding: 0px; position: absolute; right: 0px; top: -25px; width: 21px; will-change: var(--framer-will-change-effect-override, transform); z-index: 1; }`,
          `.framer-onnic .framer-1imn8oj { flex: none; height: var(--framer-aspect-ratio-supported, 17px); position: relative; width: 16px; }`,
          `.framer-onnic .framer-1n9jot8-container { flex: none; height: 113px; position: relative; width: 200px; }`,
          `.framer-onnic.framer-v-67e0op .framer-1n9jot8-container { height: 89px; width: 158px; }`,
          `.framer-onnic.framer-v-14viuwh.framer-16wermw { min-height: 148px; min-width: 255px; }`,
          `.framer-onnic[data-border="true"]::after, .framer-onnic [data-border="true"]::after { content: ""; border-width: var(--border-top-width, 0) var(--border-right-width, 0) var(--border-bottom-width, 0) var(--border-left-width, 0); border-color: var(--border-color, none); border-style: var(--border-style, none); width: 100%; height: 100%; position: absolute; box-sizing: border-box; left: 0; top: 0; border-radius: inherit; corner-shape: inherit; pointer-events: none; }`,
        ],
        `framer-onnic`
      )),
  ...
  _r = e(() => {
    (x(),
      ...
      (or = {
        tHCgLbG0e: [
          `.framer-2akaS .framer-lcqu2a-container { left: 50%; position: var(--framer-canvas-fixed-position, fixed); transform: translateX(-50%); }`,
        ],
      }),
      (sr = Object.keys(or)),
      (cr = { tHCgLbG0e: `.framer-pmyeso-override` }),
      (lr = [
        `.framer-2akaS.framer-1iygm5, .framer-2akaS .framer-1iygm5 { display: block; }`,
        `.framer-2akaS.framer-140pyj1 { --selection-background-color: var(--token-cd267c31-c786-4dde-8352-aa0f2bc35c58, #faca8b) /* {"name":"Creme"} */; --selection-color: var(--token-bca62d06-743e-42b8-943d-3b018b7cf080, #fff4e3) /* {"name":"Creme 100"} */; align-content: center; align-items: center; background-color: var(--token-129db3aa-c63b-49d4-a9df-4d7f82f7f83f, #010117); display: flex; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }`,
        `.framer-2akaS .framer-lcqu2a-container { flex: none; height: auto; order: -1000; position: sticky; top: 0px; width: 100%; z-index: 10; }`,
        `.framer-2akaS .framer-o4tdt9 { background: transparent; flex-grow: 1; height: 0px; margin: 0px; margin-bottom: -0px; position: relative; width: 0px; }`,
        `.framer-2akaS .framer-ppkyv1 { align-content: flex-end; align-items: flex-end; bottom: calc(calc(100% - min(var(--framer-viewport-height, 100%), 100%)) + 70px); display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; order: 1002; overflow: visible; padding: 0px; position: var(--framer-canvas-fixed-position, fixed); right: 20px; width: min-content; z-index: 10; }`,
        `.framer-2akaS .framer-1oiejot-container, .framer-2akaS .framer-1i19k86-container { flex: none; height: auto; position: relative; width: auto; z-index: 10; }`,
        `.framer-2akaS .framer-obna49-container { flex: none; height: 10px; order: 1003; position: relative; width: 100%; }`,
        `[data-layout-template="true"] > #overlay { margin-bottom: -0px; }`,
        `.framer-2akaS[data-selection="true"] * ::selection, .framer-2akaS [data-selection="true"] * ::selection { color: var(--selection-color, none); background-color: var(--selection-background-color, none); }`,
      ]),
      (ur = {
        I56gUQFGm: `(min-width: 1200px)`,
        pd6ytuzE1: `(min-width: 810px) and (max-width: 1199.98px)`,
                        ...
                        _(U, {
                          ...
                          children: _(Ee, {
                            ...
                            children: _(Je, {
                              ...
                              id: `FrbdWMtGW`,
                              layoutId: `FrbdWMtGW`,
                              OlthDMhqu: `Get This Template Free`,
                              r7ASsAiJ9: !0,
                              variant: $(`uGayw3Tld`),
                              width: `100%`,
                            }),
  ...
  let u = m(ve, {
    children: m(Me, {
      children: m(ke, {
        ...
        collectionUtils: Tr,
        framerSiteId: Er,
        notFoundPage: N(() => import(`./nRxv-n6GPKu6tCvTEypd8R7MZxe9GPx8o7xSQZrD048.CDFVTFvc.mjs`)),
  ...
  if (
    ...
    (Cr = {
      augiA20Il: {
        ...
        page: N(() => import(`./Oxw67_E6qJTx5zOlQmkLkksRex1seL_DxIusSLiUsfU.8IxT2T-A.mjs`)),
        path: `/`,
      },
      weKLGiygA: {
        elements: {},
        page: N(() => import(`./nRxv-n6GPKu6tCvTEypd8R7MZxe9GPx8o7xSQZrD048.CDFVTFvc.mjs`)),
        path: `/404`,
      },
    }),
    (wr = [{ code: `en`, id: `default`, name: `English`, slug: ``, textDirection: `ltr` }]),
    (Tr = {}),
...
//# sourceMappingURL=script_main.CeRI0Xdu.mjs.map
